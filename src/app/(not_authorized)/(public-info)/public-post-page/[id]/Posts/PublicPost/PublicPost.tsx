...
import {
  ReadMoreButton,
} from '@/components/ReadMoreButton/ReadMoreButton';

type Props = {
  post: PostType;
  mockedProfile: UserProfile;
};

export const PublicPost = ({ post, mockedProfile }: Props) => {
  ...
  return (
    <>
      <div className={s.postWrapper}>
        <Post post={post} userData={mockedProfile} myProfile={false} />

...
export const CroppingSizeModal = () => {
  const [active, setActive] = useState<"original" | "1:1" | "4:5" | "16:9">("original");

  return (
    <div className={s.cropping__size}>
      <div className={s.cropping__items}>
        <div className={s.cropping__item} onClick={() => setActive("original")}>
          <p className={`${active === "original" ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>Original</p>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_306_6397)">
              <path
                ...
                fill={active === "original" ? "white" : "#8D9094"}
              />
              <path
        ...
        <div className={s.cropping__item} onClick={() => setActive("1:1")}>
          <p className={`${active === "1:1" ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>1:1</p>
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect
              ...
              height="16"
              rx="2"
              stroke={active === "1:1" ? "white" : "#8D9094"}
              strokeWidth="2"
            />
          </svg>
        </div>
        <div className={s.cropping__item} onClick={() => setActive("4:5")}>
          <p className={`${active === "4:5" ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>4:5</p>
          <svg width="18" height="26" viewBox="0 0 18 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect
              ...
              height="24"
              rx="2"
              stroke={active === "4:5" ? "white" : "#8D9094"}
              strokeWidth="2"
            />
          </svg>
        </div>
        <div className={s.cropping__item} onClick={() => setActive("16:9")}>
          <p className={`${active === "16:9" ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>16:9</p>
          <svg width="26" height="20" viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect
              ...
              stroke={active === "16:9" ? "white" : "#8D9094"}
              strokeWidth="2"
            />
          </svg>
        </div>

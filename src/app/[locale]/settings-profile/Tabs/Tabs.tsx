...
const TabsDemo = () => {
    ...
    return (
        <>
                ...
                <Tabs.Content className={s.TabsContent} value="tab1">
                    <div className={s.wrapper}>
                        <div className={s.wrapper__left}>
                            ...
                            <TransparentBtn onClick={() => setShowAddAvatarModal(true)}>Add a Profile
                                Photo</TransparentBtn>
                        </div>
                ...
                <Tabs.Content className={s.TabsContent} value="tab2">
                    <div className={s.devices}>
                        ...
                        <div className={s.devices__wrapper}>
                            <Image src={'/img/settings-profile/chrome.svg'} alt={'chrome'} width={36} height={36} className={s.devices__icon}/>
            ...
            {showAddAvatarModal &&
                <Modal title={'Add a profile photo'} onClose={onCloseModal} width={'492px'}
                       isOkBtn={false}>
                    <div className={s.modal}>
                        {
                            userImage ?
                                <Image src={userImage} alt={'load-avatar'} width={316} height={316}
                                       className={s.modal__loadImg}/> :
                                <Image src={'/img/settings-profile/modal-img.png'} alt={'modal-img'} width={222}
                                       height={228} className={s.modal__img}/>
                        }
                        {
                            userImage ?

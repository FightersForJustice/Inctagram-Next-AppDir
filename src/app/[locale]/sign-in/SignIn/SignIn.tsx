            ...
            <form onSubmit={handleSubmit(onSubmit)} className={" mt-[24px] mb-10 pb-[24px]"}>
                <div className={" mt-[18px]"}>
                    ...
                    <div className={"relative"}>
                        ...
                        />
                        {errors.email && (
                            <p className={"absolute left-[5%] text-[--danger-500] text-[14px]"} id={"sign-in-errors-email-message"}>{errors.email.message}</p>
                        )}
                    </div>
                </div>
                ...
                <div className={" mt-[18px] mb-[48px]"}>
                    ...
                    <div className={"relative"}>
                        ...
                        {errors.password && (
                            <p className={"absolute left-[5%] text-[--danger-500] text-[14px]"} id={"sign-in-errors-password-message"}>{errors.password.message}</p>
                        )}
                    </div>
                </div>

                <Link href={"/forgot-password"} className={"flex justify-end mr-[20px] text-[--light-900]"} id={"sign-in-link-forgot-password"}>

  ...
  return (
    <div className={s.cropping__size}>
      <div className={s.cropping__items}>
        <div className={s.cropping__item} onClick={() => setAspectRatio("")}>
          <p className={`${aspectRatio === "" ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>Original</p>

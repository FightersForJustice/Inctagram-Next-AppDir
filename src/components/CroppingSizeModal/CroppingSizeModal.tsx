  ...
  return (
    <div className={s.cropping__size}>
      <div className={s.cropping__items}>
        <div className={s.cropping__item} onClick={() => setAspectRatio("0:0")}>
          <p className={`${aspectRatio === "0:0" ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>Original</p>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_306_6397)">
              <path
                ...
                fill={aspectRatio === "0:0" ? "white" : "#8D9094"}
              />
              <path
        ...
        <div className={s.cropping__item} onClick={() => setAspectRatio("1:1")}>
        ...
        <div className={s.cropping__item} onClick={() => setAspectRatio("4:5")}>
          <p className={`${aspectRatio === "4:5" ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>4:5</p>
          <svg width="18" height="26" viewBox="0 0 18 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect
              ...
              height="24"
              rx="2"
              stroke={aspectRatio === "4:5" ? "white" : "#8D9094"}
              strokeWidth="2"
            />
          </svg>
        </div>
        <div className={s.cropping__item} onClick={() => setAspectRatio("16:9")}>
          <p className={`${aspectRatio === "16:9" ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>16:9</p>
          <svg width="26" height="20" viewBox="0 0 26 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect
              ...
              stroke={aspectRatio === "16:9" ? "white" : "#8D9094"}
              strokeWidth="2"
            />
          </svg>
        </div>

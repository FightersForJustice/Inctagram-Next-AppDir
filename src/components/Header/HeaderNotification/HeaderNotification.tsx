      ...
      <Popover.Root onOpenChange={onOpenPopup}>
        <Popover.Trigger>
          <div className={s.notification__wrapper}>
            ...
            {amount > 0 && <span className={s.notification__span}>{amount}</span>}
          </div>
        </Popover.Trigger>
        <Popover.Portal>
            ...
            <div className={s.popup}>
              ...
              <div className={s.popup__item}>
                <p className={s.popup__item__title}>
                  Новое уведомление! <span className={s.popup__item__new}>Новое</span>
                </p>
                <p className={s.popup__desc}>Следующий платеж у вас спишется через 1 день</p>

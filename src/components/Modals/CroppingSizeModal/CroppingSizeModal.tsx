...
export const CroppingSizeModal = ({ imageId }: Props) => {
  ...
  const ratio = useAppSelector((state) =>
    state.post.changedImages.find((el) => el.id === imageId)
  );
  return (
      ...
      <div className={s.cropping__items}>
        ...
        <div
          ...
          onClick={() =>
            dispatch(
              postActions.setAspectRatio({
                aspectRatio: AspectRatioType.two,
                id: imageId,
              })
            )
          }
        >
          ...
          >
            <rect
              ...
              rx="2"
              stroke={
                ratio?.aspectRatio === AspectRatioType.two ? 'white' : '#8D9094'
              }
              strokeWidth="2"
            />
          </svg>
        ...
        <div
          ...
          onClick={() =>
            dispatch(
              postActions.setAspectRatio({
                aspectRatio: AspectRatioType.three,
                id: imageId,
              })
            )
          }
        ...
        <div
          ...
          onClick={() =>
            dispatch(
              postActions.setAspectRatio({
                aspectRatio: AspectRatioType.four,
                id: imageId,
              })
            )
          }

  ...
  return (
    <div className={s.cropping__size}>
      <div className={s.cropping__items}>
        ...
        >
          <p className={`${ratio === AspectRatioType.one ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>
            Original
          </p>
        ...
        <div className={s.cropping__item} onClick={() => dispatch(postActions.setCropAspectRatio(AspectRatioType.two))}>
          <p className={`${ratio === AspectRatioType.two ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>
            4:3
          </p>
        ...
        <div
          className={s.cropping__item}
          onClick={() => dispatch(postActions.setCropAspectRatio(AspectRatioType.three))}
        >
          <p className={`${ratio === AspectRatioType.three ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>
            4:5
          </p>
        ...
        <div
          className={s.cropping__item}
          onClick={() => dispatch(postActions.setCropAspectRatio(AspectRatioType.four))}
        >
          <p className={`${ratio === AspectRatioType.four ? `${s.cropping__text__active}` : `${s.cropping__text}`}`}>
            16:9
          </p>

    ...
    <div className={s.cropping__size}>
      <div className={s.cropping__items}>
        <div
          ...
          onClick={() => {
            dispatch(postActions.setAspectRatio({ aspectRatio: AspectRatioType.one, id: imageId }));
          }}
        >
          <p
            className={`${
              ratio?.aspectRatio === AspectRatioType.one
          ...
          >
            <g clipPath="url(#clip0_306_6397)">
              <path
                ...
                fill={ratio?.aspectRatio === AspectRatioType.one ? 'white' : '#8D9094'}
              />
              <path
        ...
        <div
          className={s.cropping__item}
          onClick={() =>
            dispatch(postActions.setAspectRatio({ aspectRatio: AspectRatioType.two, id: imageId }))
          }
        >
          <p
            className={`${
              ratio?.aspectRatio === AspectRatioType.two
                ? `${s.cropping__text__active}`
                : `${s.cropping__text}`
            }`}
          >
          ...
          >
            <rect
              ...
              height="16"
              rx="2"
              stroke={ratio?.aspectRatio === AspectRatioType.two ? 'white' : '#8D9094'}
              strokeWidth="2"
            />
          </svg>
        </div>
        <div
          className={s.cropping__item}
          onClick={() =>
            dispatch(postActions.setAspectRatio({ aspectRatio: AspectRatioType.three, id: imageId }))
          }
        >
          <p
            className={`${
              ratio?.aspectRatio === AspectRatioType.three
                ? `${s.cropping__text__active}`
                : `${s.cropping__text}`
            }`}
          >
          ...
          >
            <rect
              ...
              height="24"
              rx="2"
              stroke={ratio?.aspectRatio === AspectRatioType.three ? 'white' : '#8D9094'}
              strokeWidth="2"
            />
          </svg>
        </div>
        <div
          className={s.cropping__item}
          onClick={() =>
            dispatch(postActions.setAspectRatio({ aspectRatio: AspectRatioType.four, id: imageId }))
          }
        >
          <p
            className={`${
              ratio?.aspectRatio === AspectRatioType.four
                ? `${s.cropping__text__active}`
                : `${s.cropping__text}`
            }`}
          >
          ...
          >
            <rect
              ...
              stroke={ratio?.aspectRatio === AspectRatioType.four ? 'white' : '#8D9094'}
              strokeWidth="2"
            />
          </svg>
        </div>
